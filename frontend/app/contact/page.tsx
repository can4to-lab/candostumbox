    ...
    <div className="min-h-screen bg-[#fcfcfc] font-sans">
      ...
      <div className="bg-gray-900 text-white py-20 px-4 text-center relative overflow-hidden">
         <div className="relative z-10 max-w-2xl mx-auto">
             <span className="text-green-400 font-bold tracking-widest uppercase text-xs mb-2 block animate-fade-in-up">Bize Ulaşın</span>
             <h1 className="text-4xl md:text-6xl font-black mb-6 animate-fade-in-up delay-100">Bir Mesaj <br/> Uzağındayız</h1>
             <p className="text-gray-400 text-lg animate-fade-in-up delay-200">
               Aklına takılan bir soru mu var? Ya da sadece dostunun fotoğrafını mı paylaşmak istiyorsun? Seni dinlemek için buradayız.
             </p>
         </div>
         {/* Dekoratif Arka Plan */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:-translate-y-1 transition duration-300">
                    <div className="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-3xl mb-4">📧</div>
                    <h3 className="font-bold text-gray-900 text-lg">E-Posta</h3>
                    <p className="text-gray-500 text-sm mb-4">Genellikle 24 saat içinde yanıtlıyoruz.</p>
                    <a href="mailto:destek@candostum.com" className="text-blue-600 font-bold hover:underline">destek@candostum.com</a>
                </div>

                {/* Adres Kartı */}
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:-translate-y-1 transition duration-300">
                    <div className="w-14 h-14 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center text-3xl mb-4">📍</div>
                    <h3 className="font-bold text-gray-900 text-lg">Merkez Ofis</h3>
                    <p className="text-gray-500 text-sm mb-4">Gelin bir kahvemizi için, dostunuzla tanışalım.</p>
                    <p className="font-medium text-gray-800">16 Eylül Mah. 3042 Sokak <br/> No:24 Çeşme / İzmir</p>
                </div>
                ...
                <div className="bg-green-600 p-8 rounded-3xl shadow-xl text-white text-center">
                    ...
                    <p className="text-green-100 text-sm mb-6">Belki de sorunun cevabı Sıkça Sorulan Sorular sayfamızda hazırdır.</p>
                    <Link href="/faq" className="inline-block bg-white text-green-700 px-6 py-3 rounded-xl font-bold text-sm hover:bg-green-50 transition">
                        S.S.S'e Git 👉
                    </Link>
                </div>
                ...
                <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2 ml-1">E-posta Adresiniz</label>
                                <input 
                                    type="email" 
                                    name="email"
                                    required 
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2 ml-1">Konu</label>
                            <input 
                                type="text" 
                                name="subject"
                                required 
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2 ml-1">Mesajınız</label>
                            <textarea 
                                name="message"
                                required 
                                rows={6}
