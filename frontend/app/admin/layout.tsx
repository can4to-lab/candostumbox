      ...
      return (
          <div className="flex items-center justify-center h-screen bg-gray-50">
              <div className="text-center">
                  ...
                  <h2 className="text-xl font-bold text-gray-800">Yetki Kontrolü Yapılıyor...</h2>
    ...
    <div className="flex min-h-screen bg-[#f4f6f8]">
      ...
      <aside className="w-72 bg-[#0f172a] text-white flex flex-col fixed h-full shadow-2xl z-50">
        ...
        <nav className="flex-1 p-6 space-y-2 overflow-y-auto">
            <MenuItem href="/admin" icon="📊" text="Genel Bakış" active={pathname === '/admin'} />
            <div className="text-xs font-bold text-gray-500 uppercase mt-6 mb-2 px-4">Satış & Ürün</div>
            <MenuItem href="/admin/orders" icon="📦" text="Siparişler" active={pathname.includes('/orders')} />
            <MenuItem href="/admin/products" icon="🎁" text="Ürünler & Paketler" active={pathname.includes('/products')} />
            <MenuItem href="/admin/subscriptions" icon="🔄" text="Abonelikler" active={pathname.includes('/subscriptions')} />
            
            <div className="text-xs font-bold text-gray-500 uppercase mt-6 mb-2 px-4">Kullanıcılar</div>
            <MenuItem href="/admin/users" icon="👥" text="Müşteriler" active={pathname.includes('/users')} />
            
            <div className="text-xs font-bold text-gray-500 uppercase mt-6 mb-2 px-4">Ayarlar</div>
            <MenuItem href="/admin/discounts" icon="🏷️" text="İndirim Yönetimi" active={pathname.includes('/discounts')} />
        </nav>
      ...
      <main className="flex-1 ml-72 p-10 animate-fade-in">
         ...
         <div className="flex justify-between items-center mb-8">
             <button className="lg:hidden">☰ MENÜ</button> {/* Mobilde sidebar açmak için ilerde eklenebilir */}
             <div></div> {/* Boşluk */}
