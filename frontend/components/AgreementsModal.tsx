      ...
      <div className="bg-white rounded-3xl w-full max-w-3xl h-[80vh] flex flex-col shadow-2xl animate-fade-in-up relative">
        ...
        <div className="p-8 overflow-y-auto custom-scrollbar flex-grow text-sm text-gray-600 leading-relaxed space-y-4">
          ...
          <p>
            ...
            <br />
            Ünvanı: Can Dostum Box (Günen Ticaret İnşaat Yapı Market)
            <br />
            Adresi: 16 Eylül Mah. 3042 Sok. No:24 Çeşme/İzmir
            <br />
          ...
          <p>
            ...
            elektronik ortamda siparişini yaptığı ürünün satışı ve teslimi ile
          ...
          <p>
            <strong>MADDE 3 – ÜRÜN BİLGİLERİ</strong>
          </p>
          <p>
            Sipariş edilen abonelik paketinin türü, süresi ve satış bedeli ödeme
            sayfasında belirtildiği gibidir.
          </p>

          <p>
            <strong>MADDE 4 – CAYMA HAKKI</strong>
          </p>
          <p>
            ALICI, 14 gün içinde sebep göstermeksizin cayma hakkına sahiptir.
            Ancak, kişiye özel hazırlanan (pet ismine özel) ürünlerde veya
            açılmış hijyenik ürünlerde/mamalarda cayma hakkı kullanılamaz.
          </p>

          <p>
            <strong>MADDE 5 – YETKİLİ MAHKEME</strong>
          </p>
          <p>
